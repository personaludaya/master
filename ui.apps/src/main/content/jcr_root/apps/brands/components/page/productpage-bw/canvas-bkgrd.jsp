...
%><%
String defBkgrdImg	  = imgPath + "/template/background/brands-campaign-bg-img.jpg";
...
<div class="background-container <c:out value="${varPageBkgrdStyle}"/>" style="background-image: url(<c:out value="${varPageBkgrdImg}"/>)" data-rjs="2" data-top="background-position: center 0px" data-top-bottom="background-position: center -100%" <%if(!disabledParallax.equals("true")){%>data-speed="<%=dataSpeed%>"<%}%>>
