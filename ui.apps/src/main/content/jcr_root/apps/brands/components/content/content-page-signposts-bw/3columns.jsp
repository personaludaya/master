...
<c:if test="${fn:length(varContentPageSignpostPathsArr) > 0}">
 <div class="generic-3c-component primary-color component-style1">
		...
		<div class="row">
		 ...
		 <%
			  for (int i = 0; i < contentPageSignpostPathsArr.length ; i++) {
				  Page contentSignpostPage = pageManager.getPage(contentPageSignpostPathsArr[i]);
				  
				  BasicController basicController = new BasicController();
				  Basic basic = new Basic();
				  basic = basicController.getBasicPageProperties(contentSignpostPage, isAuthor, slingRequest);
				  Map<String, String> contentPageSignpostMapTags = basic.getBasicTagsKeywordsMap();
				  
				  GeneralController generalController = new GeneralController();
				  General general = new General();
				  general = generalController.getGeneralPageProperties(contentSignpostPage, isAuthor, slingRequest);
				  
				  String contentSignpostPath = WCMUtil.getURL(contentSignpostPage.getPath(), isAuthor);
		 %>
               <c:set var="varContentSignpostDesc" value="<%= basic.getBasicOverview() %>"/>
               <c:set var="varContenttSignpostTitle" value="<%= basic.getBasicPageTitle() %>"/>
               ...
               <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              	 	<div class="article primary-color component-style1 text-left">
              	 	   ...
              	 	   <a href="${varContentSignpostPath}"><h4 class="text-left">${varContenttSignpostTitle}</h4></a>
