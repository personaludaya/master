...
%><%@page import="org.apache.sling.api.resource.ResourceUtil,
    ...
    for(String suffix : new String [] { "/", "/*" }) {
        if(path.endsWith(suffix)) {
            ...
            request.setAttribute("varFormTransactionId", uniqueId);
    ...
    String thankYouPath = props.get("redirect", "");
    request.setAttribute("redirectPath", thankYouPath);
    FormsHelper.setForwardRedirect(request, thankYouPath);
