...
%>
     ...
     <div class="form-group dropdown-group">
	        ...
	        <svg class="brands-icon">
                <use href="/etc/designs/brands/clientlib-site/images/icons/symbol-defs.svg#icon-dropdown" xlink:href="/etc/designs/brands/clientlib-site/images/icons/symbol-defs.svg#icon-dropdown"></use>
            </svg>
